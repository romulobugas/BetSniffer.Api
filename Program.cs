    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.WebHost.ConfigureKestrel(serverOptions =>
            {
                ...
                {
                    serverOptions.ListenAnyIP(5000); // Apenas HTTP em produ��o
                }
            });

            // Configura��o do WebDriver como Singleton
            builder.Services.AddSingleton<IWebDriver>(serviceProvider =>
            {
                var options = new ChromeOptions();
                options.AddArgument("--disable-gpu");
                options.AddArgument("--no-sandbox");
                options.AddArgument("--headless"); // Remova esta linha para depura��o visual
            ...
            // Adiciona ScrapingSettings como uma configura��o injet�vel
            builder.Services.Configure<ScrapingSettings>(builder.Configuration.GetSection("ScrapingSettings"));


            // Registra a f�brica para uso em servi�os ou controladores
            builder.Services.AddScoped<ApplicationDbContextFactory>();

            // Registro de reposit�rios gen�ricos
            builder.Services.AddScoped(typeof(IRepositoryService<>), typeof(RepositoryService<>));

            // Registro de servi�os espec�ficos
            ...
            // Configura��o de CORS (libera��o total)
            ...
            // Configura��o para servir arquivos est�ticos do front
            app.UseStaticFiles(new StaticFileOptions
            {
                FileProvider = new Microsoft.Extensions.FileProviders.PhysicalFileProvider(
                    Path.Combine(builder.Environment.ContentRootPath, "Frontend")),
                RequestPath = "",
                ServeUnknownFileTypes = true, // Permite servir qualquer tipo de arquivo est�tico
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.RoutePrefix = "swagger"; // Swagger acess�vel em /swagger
            });
