...
namespace BetSniffer.Api.Core.Sites.Betfair
{
    public static class BetfairTags
    {
        ...
        private static readonly Dictionary<int, List<string>> BaseTagNames = new()
        {
            ...
            { 1, new List<string> { "Mais/menos escanteios" } },
            { 8, new List<string> { "Mais/menos escanteios Casa", "Mais/menos escanteios" } },
            { 9, new List<string> { "Mais/menos escanteios Fora", "Mais/menos escanteios" } },
            { 34, new List<string> { "Mais/Menos Cartões" } },
            ...
            { 35, new List<string> { "Mais/Menos Cartões Casa", "Mais/Menos Cartões" } },
            { 36, new List<string> { "Mais/Menos Cartões Fora", "Mais/Menos Cartões" } },
