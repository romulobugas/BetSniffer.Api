...
{
    public class BetboomScraping : IScrapingService
    {
        ...
        public async void Task<HandleModal>(IPage page, string modalSelector, string closeButtonSelector, int timeoutMilliseconds = 10000)
        {
            try
            {
